const Landing = () => {
  ...
  return (
    <div className="relative h-full">
      ...
      <img src ="src/svg.png" alt="" className="w-full absolute bottom-0 h-3/6 opacity-50" />
      <img src="src/email_icon_2.png" alt="" className="h-20 w-20 absolute bottom-44 lg:bottom-64 right-40 lg:right-48 loading-text" />
